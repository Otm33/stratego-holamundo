  ...
  render(matrix) {
    ...
    matrix.forEach((row, rowIndex) => {
      row.forEach((cellContent, colIndex) => {
        ...
        cellElement.dataset.row = rowIndex;//guarda las coordenadas de las filas
        cellElement.dataset.col = colIndex;//guarda las coordenadas de las columnas
        if (cellContent === 'LAKES') {
          ...
          //hacer a las piezas ya colocadas moviblehacer a las piezas ya colocadas movibless
          ...
          pieceElement.addEventListener('dragstart', (e) => {
            e.dataTransfer.setData('text/plain', JSON.stringify({
              ...
              fromRow: rowIndex,
              fromCol: colIndex,
              rank: cellContent.rank,
              team: cellContent.team
            }));
          });
